...
#define TIMERSTEP       500000           // Defined as 0.1 sec (Arduino counts the time in microsecs) in order to set the frequency in a more user friendly way
#define Kmes         125/360

 TimerObject *timer1 = new TimerObject(100);       
...
double D;
  ...
  double Input;
  double Setpoint=300;
  double aggKp=1.5, aggKi=0.5, aggKd=0.05;
...
void callback(){
  ...
  velocityA=(position2A-position1A)*60/0.5; // due to timestep
