...
#define Kmes         0.25 // 255/100 from speed to duty constant       
...
volatile unsigned long int timercounterA=0;  // counts the rising edges of the encoder reading
int velocityA;
double Setpoint=30;
...
double count=0;
double Input;
double aggKp=1.16, aggKi=0, aggKd=0.44;
...
void callback(){
   ...
   velocityA=(position2A-position1A)*60;
